...
You can read [this tutorial](https://blog.codeselfstudy.com/blog/deploy-node-postgres-heroku/) on deploying an Express app with Postgres on Heroku and running knex migrations and seeds. 
